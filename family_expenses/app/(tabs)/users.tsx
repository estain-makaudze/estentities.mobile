...
export default function UsersScreen() {
  ...
  const handleDelete = (user: User) => {
    Alert.alert(
      "Remove User",
      `Remove "${user.name}"? Their past expenses and settlements will still be stored but will appear as "Unknown".`,
      [
        { text: "Cancel", style: "cancel" },
        { text: "Remove", style: "destructive", onPress: () => deleteUser(user.id) },
      ]
    );
  };
      ...
      <View style={styles.container}>
        ...
        {users.length === 0 ? (
          <View style={styles.empty}>
            ...
            <Text style={styles.emptySubtext}>Add the people who share expenses together.</Text>
          </View>
        ) : (
          <FlatList
            data={users}
...
const styles = StyleSheet.create({
  ...
  input: {
    ...
    fontSize: 16, color: "#1C1C1E", borderWidth: 1, borderColor: "#E5E5EA", marginBottom: 12,
  },
  ...
  colorSwatchSelected: { borderWidth: 3, borderColor: "#1C1C1E" },
  addBtn: { backgroundColor: "#4A90D9", borderRadius: 12, padding: 14, alignItems: "center" },
